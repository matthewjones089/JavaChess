import java.util.ArrayList;
    ...
    public class Book
    {
        public static ArrayList<OpeningMove> LoadOpeningBook()
		{
			return PopulateOpeningBook();
        }

        public static ArrayList<OpeningMove> PopulateOpeningBook()
        {
        	ArrayList<OpeningMove> openingBook = new ArrayList<OpeningMove>();
        	
            openingBook.addAll(PopulateOpeningBook1());
            openingBook.addAll(PopulateOpeningBook2());
            openingBook.addAll(PopulateOpeningBook3());

            return openingBook;
        }

        public static int ValidateOpeningBook(ArrayList<OpeningMove> openingBook)
        {
            int failed = 0;

            for (OpeningMove moves : openingBook)
            {
                for (MoveContent move : moves.Moves)
                {
        ...
        private static boolean IsValidMove(byte srcPos, byte dstPos, String fen)
        {
            ...
            if (chessBoard.Squares[srcPos].Piece.PieceType == chessPiece.ChessPieceType.None)
            {
                return false;
            }

            for (byte bs : chessBoard.Squares[srcPos].Piece.validMoves)
            {
                if (bs == dstPos)
                {
                    return true;
        ...
        public static ArrayList<OpeningMove> PopulateOpeningBook1() {
        	ArrayList<OpeningMove> openingBook = new ArrayList<OpeningMove>();
            String moveLine;
        ...
        public static ArrayList<OpeningMove> PopulateOpeningBook2() {
        ...
        public static ArrayList<OpeningMove> PopulateOpeningBook3() {
